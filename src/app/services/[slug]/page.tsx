    ...
    <>
      ...
      <section className="bg-slate-50 py-12 md:py-16">
        <div className="container">
          <SectionHeading title="Why customers choose this service" description={`Trusted by homeowners in ${siteContent.city} for practical, clear HVAC support.`} />
          ...
          <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link href="/request-quote" className="rounded-full border border-slate-300 px-5 py-3 font-semibold">Request Quote</Link>
            </div>
          </div>
        </div>
      </section>
